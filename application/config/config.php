...
|
*/
$config['base_url'] = 'http://localhost/codeigniter_crudy';
...
|
*/
$config['encryption_key'] = 'your-secure-key-here-12345';
...
$config['proxy_ips'] = '';
$config['sess_driver'] = 'files';
$config['sess_save_path'] = sys_get_temp_dir(); // or a writable path like APPPATH.'cache/sessions'
$config['sess_cookie_name'] = 'ci_session';
$config['sess_expiration'] = 7200;
$config['sess_time_to_update'] = 300;
$config['sess_regenerate_destroy'] = FALSE;
