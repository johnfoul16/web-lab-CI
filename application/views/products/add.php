...
<body>
    <div class="container">
        <div class="header">
            ...
            <p class="subtitle">Create a new product for listing</p>
        </div>
        ...
        <form method="post" action="<?= site_url('UserController/store'); ?>" enctype="multipart/form-data" class="form-container">
            <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">
            
            <div class="form-group">
                <label for="name" class="label">Product Name</label>
                <input type="text" id="name" name="name" class="input" value="<?= set_value('name'); ?>" placeholder="Enter product name" required>
                <?php echo form_error('name', '<div class="error-text">', '</div>'); ?>
            </div>
            
            <div class="form-group">
                <label for="description" class="label">Description</label>
                <textarea id="description" name="description" class="textarea" placeholder="Describe your product..."><?= set_value('description'); ?></textarea>
            ...
            <div class="price-stock-group">
                <div class="form-group">
                    ...
                    <input type="number" id="price" name="price" step="0.01" min="0" class="input" value="<?= set_value('price'); ?>" placeholder="0.00" required>
                    <?php echo form_error('price', '<div class="error-text">', '</div>'); ?>
                </div>
                
                <div class="form-group">
                    <label for="stock" class="label">Stock</label>
                    <input type="number" id="stock" name="stock" min="0" class="input" value="<?= set_value('stock'); ?>" placeholder="0" required>
